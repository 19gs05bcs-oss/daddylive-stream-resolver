...
const SITE_TITLE = "DaddyLive (DLHD) Stream Resolver";
const SITE_DESC =
  "Resolve DLHD streams to direct URLs, proxy with embed referer, play in-browser, and copy VLC or MPV commands.";
